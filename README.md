...
个人2021年年初曾参考一个模块化的项目（[SimplCommerce](https://github.com/simplcommerce/SimplCommerce)），试着从0到1搭建一个完整的项目，并应用在工作的项目里（当时就我一个开发，想搞啥搞啥，可太爽了）。今年再看那个项目，虽说结构、代码都很干净，但很多想法及实现还是太稚嫩了。而且模块化的架构，实际上只是更贴近我当时（上上家）的业务场景，不太适应通用的情况。
